...
def account_info():
    ...
    return render_template('accountPages/account.html', user=user, driver=driver, ridesListed=ridesListed, reservations=reservations, rideToday=rideToday, revToday=revToday)

#returns the upcoming rides in the ridesListed variable and if there is a ride on today's date it puts it in the rideToday variable and removes it from the list
